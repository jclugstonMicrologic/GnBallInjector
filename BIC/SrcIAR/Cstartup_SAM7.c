...
//this is the eval board WITH A 18.432MHz Main Osc. Freq 
...
*/
// this is our board with a 16MHz Main Osc. Freq
		// - div by 4  = 4000000 =(16000000 /4)
		// - Mul 23+1: Fout =	96MHz =(4000000 *24)
		// for 96 MHz the error is 0.00%
		// Field out NOT USED = 0
